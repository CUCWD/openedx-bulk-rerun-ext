...
"""
openedx-bulk-rerun-ext documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-bulk-rerun-ext',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/CUCWD/openedx-bulk-rerun-ext",
...
#
# html_title = 'openedx-bulk-rerun-ext v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Bulk course and program rerun API endpoints',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_bulk_rerun_ext'),
                os.path.join(root_path, 'openedx_bulk_rerun_ext/migrations')])
