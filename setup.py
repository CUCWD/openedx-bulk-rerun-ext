#!/usr/bin/env python
"""
Package metadata for openedx_bulk_rerun_ext.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_bulk_rerun_ext', '__init__.py')
...
setup(
    name='openedx-bulk-rerun-ext',
    version=VERSION,
    description="""Bulk course and program rerun API endpoints""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Zachary Trabookis',
    author_email='ztraboo@clemson.edu',
    url='https://github.com/CUCWD/openedx-bulk-rerun-ext',
    packages=find_packages(
        include=['openedx_bulk_rerun_ext', 'openedx_bulk_rerun_ext.*'],
        exclude=["*tests"],
    ),
